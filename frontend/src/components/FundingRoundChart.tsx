...
return <div className={'font-display p-5 flex flex-col gap-5'}>
  ...
  <Loader isLoading={loading} className={'flex flex-col gap-5'}>
    <Pagination totalCount={totalCount} offset={offset} limit={limit} onOffsetChange={setOffset} />
