...
export const OrganizationQueryDocument = {
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "OrganizationOrderByInput" },
          },
        },
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "fundingRoundOrderBy" },
          },
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "FundingRoundsOrderByInput" },
          },
        },
        {
          kind: "VariableDefinition",
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "fundingRounds" },
                        arguments: [
                          {
                            kind: "Argument",
                            name: { kind: "Name", value: "orderBy" },
  ...
  OrganizationQueryQuery,
  OrganizationQueryQueryVariables
>;
